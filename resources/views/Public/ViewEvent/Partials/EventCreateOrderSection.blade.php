    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-pull-4">
            <div class="event_order_form">
                {!! Form::open(['url' => route('postValidateOrder', ['event_id' => $event->id ]), 'class' => 'payment-form ajax']) !!}
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            {!! Form::text("order_first_name", Auth::check() ? auth()->user()->last_name : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            {!! Form::label("order_last_name", trans("Public_ViewEvent.last_name")) !!}
                            {!! Form::text("order_last_name", Auth::check() ? auth()->user()->last_name : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text("order_email", Auth::check() ? auth()->user()->email : null, ['required' => 'required', 'class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
