...
$data = session()->get('extra_payfast_data');


$htmlForm = '<form action="https://'.$pfHost.'/eng/process" method="post" id="payfast-form">';
...
<div class="row">
    <div class="col-sm-12">
        <h3 style="text-align:center; color:white">Redirecting You to PayFast to Complete the Payment...</h3>
    </div>
</div>
