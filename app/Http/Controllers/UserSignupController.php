...
class UserSignupController extends Controller
{
    ...
    public function showCustomersSignup(){
        $is_attendize = Utils::isAttendize();
        return view('Public.LoginAndRegister.customers-signup', compact('is_attendize'));
    }
    ...
    public function postSignup(Request $request)
    {
        ...
        $user_data['user_type'] = $request->input('user_type');
